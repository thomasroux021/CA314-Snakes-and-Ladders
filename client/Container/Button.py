...
class Button:
    def __init__(self, x, y, w, h, max_width, color, status, text=''):
    ...
    def draw(self, screen):
        ...
        screen.blit(self.txt_surface, (self.center_x(self.txt_surface), self.box.y + self.center_h(self.box.h, self.txt_surface)))
        # Blit the rect.
